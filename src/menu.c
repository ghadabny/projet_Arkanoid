...
bool afficher_menu(SDL_Window* window, SDL_Surface* surface) {
    ...
    TTF_Font* titleFont = TTF_OpenFont("/usr/share/fonts/truetype/liberation/LiberationSans-Regular.ttf", 80); // Augmenter la taille de la police pour le titre
    TTF_Font* buttonFont = TTF_OpenFont("/usr/share/fonts/truetype/liberation/LiberationSans-Regular.ttf", 40);
